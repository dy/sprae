...
<!-- reusable: a function by name is called with the new scope -->
<div :scope="counter">...</div>
```
...
Sprae is ~1.7× smaller, ~2.8× faster, and uses ~4.5× less runtime memory in [this comparison](https://sprae.js.org/compare). It has pluggable signals, built-in modifiers, event chains, and a full-JS [CSP build](https://sprae.js.org/csp).
