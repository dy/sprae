...
and uses a wider, content-sized dark surface. Keyboard focus, or a tap on touch screens, pins the example for reading, selection, and scrolling; it is a plain popover, dismissed by a tap outside or Escape, with no close control. With a fine pointer a click does nothing extra: the hover preview is the whole interaction.
